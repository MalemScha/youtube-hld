...
const VideoPage = () => {
    ...
    const getVideoDetails = async () => {
        try{
            ...
            const url = videoDetails.transcodeURL === '' ? videoDetails.url : videoDetails.transcodeURL
        ...
        <div className='flex'>
            ...
            <div className={`${menuActive ? 'ml-6' : 'ml-16'}`}>
                ...
                <div className='pt-1 flex justify-between items-center'>
                    <div className='p-2'>
                        <h5 className="text-2xl font-bold tracking-tight text-white">{videoData?.title}</h5>
                    </div>
                    <div className='flex justify-center items-center gap-4 py-2 mr-2'>
                ...
                <div className='p-2 pt-1'>
                    <p className='text-xl text-gray-300 font-medium'>{videoData?.description}</p>
                </div>
            </div>
            <div className='pl-12 flex justify-center grow' >
                <SimilarVideos />
            </div>
        </div>
    </div>
